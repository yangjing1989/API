...
$(document).ready(function(){
    ...
    $("#add_project_save").click(function(){
        var project_level = selected_node_level+1;
        var parent_project_id = selected_node_id;
        var project_name = $("#project_name").val();
        var api_document = $("#api_document").val();
        $.post("/api/project/add/",{project_level:project_level,parent_project_id:parent_project_id,project_name:project_name,
                                    api_document:api_document},function(result){
